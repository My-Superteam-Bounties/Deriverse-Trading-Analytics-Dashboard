                    ...
                    {notifications.map((notification) => (
                        <div
                            ...
                            className={cn(
                                ...
                                notification.read ? "bg-card/50 border-border opacity-70" : "bg-card border-amber-500/30 shadow-lg shadow-amber-900/5"
                            )}
                        >
                            <div className={cn(
                            ...
                            <div className="flex-1">
                                <div className="flex items-center justify-between mb-1">
                                    <h3 className={cn("font-medium", !notification.read && "text-amber-500")}>
                                        {notification.title}
                                    </h3>
