            ...
            <div className="max-w-2xl w-full text-center space-y-8">
                ...
                <div className="flex justify-center">
                    <div className="relative">
                        <div className="absolute inset-0 bg-primary/20 rounded-full blur-2xl opacity-20 animate-pulse" />
                        <div className="relative bg-card/50 p-8 rounded-full border border-primary/20">
                ...
                <div className="bg-card/30 border border-border rounded-2xl p-8 space-y-4">
                    ...
                    <div className="grid gap-3">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="flex items-center gap-3 text-left p-3 rounded-lg bg-card/50 border border-border hover:border-primary/20 transition-colors"
                            >
